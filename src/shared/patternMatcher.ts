...
import { DICT_WORDS, DICT_LABELS, PATTERN_LEN, getTransmitBit, type DictWord } from './dictionary.js';
...
export class PatternMatcher {
  ...
  private scoreCurrentWindow(): MatchResult | null {
    ...
    if (bestScore >= this.threshold && bestWord !== null) {
      return { word: bestWord, score: bestScore, label: DICT_LABELS[bestWord] };
    }
    return null;
  }
