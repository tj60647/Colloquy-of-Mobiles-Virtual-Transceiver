import type { DictWord } from './dictionary.js';
import type { SampleDecisionStrategy, ScalarSampleTick } from './samplePipeline.js';
import { ScalarSampleProcessor } from './samplePipeline.js';
